...
<head>
    <!-------------Linha---------->
    <title>Rock - Tattoo Studio - ILUSTRAÇÃO</title>
</head>
    ...
    <div class="container2">
        <div class="wrapper">
            ...
            <ul id="sb-slider" class="sb-slider">
                <li>
                    <a  target="_blank"><img src="Imagens/img29.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>ILUSTRAÇÃO</h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img30.jpg" alt="image2" /></a>
                    <div class="sb-description">
                        <h3>ILUSTRAÇÃO</h3>
                    </div>
                </li>
                <li>
                    <a target="_blank"><img src="Imagens/img31.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>ILUSTRAÇÃO</h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img32.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>ILUSTRAÇÃO</h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img33.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>ILUSTRAÇÃO</h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img34.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>ILUSTRAÇÃO</h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img35.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>ILUSTRAÇÃO</h3>
                    </div>
                </li>
