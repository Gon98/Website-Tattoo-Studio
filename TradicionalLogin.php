...
<head>
    <!-------------Linha---------->
    <title>Rock - Tattoo Studio - TRADICIONAL</title>
</head>
    ...
    <div class="container2">
        <div class="wrapper">
            ...
            <ul id="sb-slider" class="sb-slider">
                <li>
                    <a  target="_blank"><img src="Imagens/img36.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>TRADICIONAL </h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img37.jpg" alt="image2" /></a>
                    <div class="sb-description">
                        <h3>TRADICIONAL </h3>
                    </div>
                </li>
                <li>
                    <a target="_blank"><img src="Imagens/img38.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>TRADICIONAL </h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img39.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>TRADICIONAL </h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img40.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>TRADICIONAL </h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img41.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>TRADICIONAL </h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img42.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>TRADICIONAL </h3>
                    </div>
                </li>
