...
<link rel="stylesheet" type="text/css" href="tatuadorV1.1.css">
<link rel="stylesheet" type="text/css" href="tatuador1.1.css">
...
<link rel="stylesheet" href="tatuagens.css">
...
<head>
    <!-------------Linha---------->
    <title>Rock - Tattoo Studio - EQUIPA</title>
</head>
...
<body>
    ...
    <nav>
        ...
        <ul class="nav-links">
            <li>
                <a class="clicar" href="InicioLogin2.php">Início</a>
            </li>
            <li>
                <a class="clicar" href="#">Loja</a>
            </li>
            <li>
    ...
    <div class="retangulo2">
      ...
      <li>
            <div class="estudio-info">
                  ...
                  <p>Artista fundador do estúdio, Gonçalo tem 30 anos e é de origem de 
                    Gondomar. Tatuadora desde 2011, os seus estilos preferidos 
                    são o Preto e Cizento, a Geometria e a linha. O artista ganhou
                    vários prémios alguns anos consecutivos, com o primeiro premio 
                    em Trabalho em linha/Tribal, em várias convenções de tatuagens internacionais.</p>
          </div>
      ...
      <div class="container3">
        <div class="text_skill">Habilidades</div>
        <div class="bar learning" data-skill="GEOMETRIA"></div>
        <div class="bar back basic" data-skill="PRETO/CINZENTO"></div>
        <div class="bar back intermediate" data-skill="LINHA"></div>
...
<div class="modal2" id="modal2">
        ...
        <div class="box">
           ...
           <div class="inputBox">
            <input type="password" id="password"  SIZE=5 MAXLENGTH=8 required>
            <label>Palavra-Passe</label>
        </div>
                <div class="inputBox">
                    <input type="password" id="confirm_password" SIZE=8 MAXLENGTH=8 required>
                    <label>Palavra-Passe</label>
                </div>
    
                <input  href="#" type="submit" name="" value="Editar">
