...
<head>
    <!-------------Linha---------->
    <title>Rock - Tattoo Studio - LETRAS</title>
</head>
...
<body>
    ...
    <nav>
        ...
        <ul class="nav-links">
            ...
            <li>
                <a class="clicar" href="#">Marcações</a>
            </li>
            <li>
    ...
    <div class="container2">
        <div class="wrapper">
            ...
            <ul id="sb-slider" class="sb-slider">
                <li>
                    <a  target="_blank"><img src="Imagens/img15.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>LETRAS</h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img16.jpg" alt="image2" /></a>
                    <div class="sb-description">
                        <h3>LETRAS</h3>
                    </div>
                </li>
                <li>
                    <a target="_blank"><img src="Imagens/img17.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>LETRAS</h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img18.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>LETRAS</h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img19.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>LETRAS</h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img20.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>LETRAS</h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img21.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>LETRAS</h3>
                    </div>
                </li>
