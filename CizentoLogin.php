...
<head>
    <!-------------Linha---------->
    <title>Rock - Tattoo Studio - PRETO E CIZENTO </title>
</head>
    ...
    <div class="container2">
        <div class="wrapper">
            ...
            <ul id="sb-slider" class="sb-slider">
                <li>
                    <a  target="_blank"><img src="Imagens/img8.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>PRETO E CIZENTO</h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img9.jpg" alt="image2" /></a>
                    <div class="sb-description">
                        <h3>PRETO E CIZENTO</h3>
                    </div>
                </li>
                <li>
                    <a target="_blank"><img src="Imagens/img10.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>PRETO E CIZENTO</h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img11.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>PRETO E CIZENTO</h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img12.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>PRETO E CIZENTO</h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img13.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>PRETO E CIZENTO</h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img14.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>PRETO E CIZENTO</h3>
                    </div>
                </li>
