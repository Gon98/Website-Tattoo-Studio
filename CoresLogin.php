...
<head>
    <!-------------Linha---------->
    <title>Rock - Tattoo Studio - CORES</title>
</head>
    ...
    <div class="container2">
        <div class="wrapper">
            ...
            <ul id="sb-slider" class="sb-slider">
                <li>
                    <a  target="_blank"><img src="Imagens/img22.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>CORES</h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img23.jpg" alt="image2" /></a>
                    <div class="sb-description">
                        <h3>CORES</h3>
                    </div>
                </li>
                <li>
                    <a target="_blank"><img src="Imagens/img24.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>CORES</h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img25.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>CORES</h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img26.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>CORES</h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img27.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>CORES</h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img28.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>CORES</h3>
                    </div>
                </li>
