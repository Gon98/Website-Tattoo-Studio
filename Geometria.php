...
<head>
    <!-------------Linha---------->
    <title>Rock - Tattoo Studio - Geometria / Linha</title>
</head>
    ...
    <div class="container2">
        <div class="wrapper">
            ...
            <ul id="sb-slider" class="sb-slider">
                <li>
                    <a  target="_blank"><img src="Imagens/img1.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>Geometria / Linha</h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img2.jpg" alt="image2" /></a>
                    <div class="sb-description">
                        <h3>Geometria / Linha</h3>
                    </div>
                </li>
                <li>
                    <a target="_blank"><img src="Imagens/img3.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>Geometria / Linha</h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img4.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>Geometria / Linha</h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img5.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>Geometria / Linha</h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img6.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>Geometria / Linha</h3>
                    </div>
                </li>
                <li>
                    <a  target="_blank"><img src="Imagens/img7.jpg" alt="image1" /></a>
                    <div class="sb-description">
                        <h3>Geometria / Linha</h3>
                    </div>
                </li>
